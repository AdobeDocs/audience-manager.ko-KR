...
seo-description: 2016년에 출시된 신규 및 수정된 Audience Manager 설명서 목록. Experience Cloud 릴리스 노트에 포함되지 않았을 수 있는 Audience Manager 안내서의 작은 업데이트 또는 변경 사항이 포함되어 있습니다.
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>허용 목록 <span class="keyword"> Audience Manager</span> IP 및 FTP 주소에 대한 새 항목을 포함합니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Google의 Universal Analytics에서 <span class="keyword"> Audience Manager</span>로 데이터를 보낼 수 있는 새 DIL 방법을 설명하는 문서입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience </span> Manager는 동일한 방식으로 방문자 ID 인증  <code> UNKNOWN</code> 상태 <code> LOGGED_OUT</code> 를 처리합니다. 이 문서에서는 <code> setCustomerID</code> 이벤트 호출을 처리하는 방법에 대한 자세한 정보를 제공합니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle"> 대응 가능 대상</span> 및 <span class="wintitle"> 대상</span>에 대한 시간 간격이 작동하는 방식을 설명하는 새 콘텐츠입니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><code> GA.init()</code>이 Google의 최신 버전의 분석 코드 <code> analytics.js</code>에서 작동하지 않는다는 참고 사항으로 수정되었습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="keyword"> Adobe Experience Cloud Device Co-op</span>에 대한 자세한 정보를 포함하도록 수정되었습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>DIL이 <code> GET</code> 및 <code> POST</code> 메서드를 사용하여 이벤트 호출에서 데이터를 보내는 이유를 설명하는 컨텐츠가 업데이트되었습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle"> Audience Optimization</span>보고서를 채널 간 전환, 역할 기반 액세스 제어, 전환 그룹 및 보고된 전환 트레이트 보고서가 업데이트되었습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><span class="keyword"> Audience Manager</span> 설명서에서 제거되었습니다. <span class="keyword"> Analytics</span> 설명서로 이동되었습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 픽셀 호출을 통해 캠페인 노출 횟수 데이터 캡처 </a> </p> </td> 
   <td colname="col2"> <p><code> d_cid</code>으로 모바일 ID 전달을 포함하도록 업데이트되었습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이름이 지정된 새 연산자 <code> Matcheswords</code>가 추가되었습니다. 정규 표현식을 사용하지 않고 일치하는 단어 패턴을 지정할 수 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">공급자가 내 데이터 피드를 비활성화하면 어떻게 됩니까?</a> </p> </td> 
   <td colname="col2"> <p>공급자가 데이터 피드에 대한 액세스를 취소한 경우 <span class="wintitle"> Audience Marketplace</span> 데이터 구매자가 예상할 수 있는 내용을 설명합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS 오류 코드, 메시지 및 예제 </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>세그먼트 데이터를 Google AdWords 리마케팅 목록에 보내는 방법에 대한 지침입니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle"> Audience Marketplace</span> 청구 보고서에 항목을 나열하고 정의하는 새 설명서입니다. </p> </td> 
  </tr> 
  <tr> 
