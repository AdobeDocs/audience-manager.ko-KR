---
description: 대상 세부 사항 페이지에 대상자 랩 매핑 세그먼트가 표시되지 않는 이유입니다.
...
title: 대상 세부 사항 페이지에 대상자 랩 매핑 세그먼트가 표시되어야 합니까?
feature: Support
...
# 대상 세부 사항 페이지에 대상자 랩 매핑 세그먼트가 표시되어야 합니까? {#audience-lab-segments-destination-page}
...
세그먼트는 대상자 랩 세그먼트 테스트에 표시됩니다.

![대상자 랩 세그먼트 보기 이미지](assets/should_i_see_my_aamlab01.png)
