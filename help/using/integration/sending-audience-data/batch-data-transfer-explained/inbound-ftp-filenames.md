...
[!DNL Audience Manager]에 데이터를 보낼 때 따라야 하는 필수 필드, 구문, 이름 지정 규칙 및 파일 크기를 설명합니다. Audience Manager [!DNL FTP] 디렉터리로 데이터를 보낼 때 이러한 사양에 따라 파일의 이름과 크기를 설정하십시오.
