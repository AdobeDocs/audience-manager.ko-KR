...
| 주제 | 설명 |
|---- |----|
| [Audience Manager의 접근성](../overview/accessibility-in-aam.md) | 액세서빌러티(Accessibility) 는 시각, 청각, 인지, 모터 또는 기타 종류의 장애와 같은 다양한 장애가 있는 사용자로부터 가능한 한 최소한의 노력으로 소프트웨어 제품을 사용 가능하게 만드는 일련의 기능을 말합니다. 모든 사용자가 Audience Manager을 보다 손쉽게 사용할 수 있도록 이 문서에 자세히 설명되어 있는 다양한 접근성 기능에 대한 지원을 개발했습니다. |
