---
description: 중복 보고서가 백만 개의 레코드 제한에 도달하는 경우 이 보고서에 대한 .csv 파일을 요청할 수 있습니다. "예기치 않은 오류가 발생했습니다"라는 메시지가 표시되면 보고서가 이 제한에 도달했을 수 있습니다. 자체 데이터베이스 시스템에서 가져오고 작업할 수 있는 압축된 .csv 파일을 요청하려면 고객 지원 센터에 문의하십시오. 파일은 세그먼트 간, 세그먼트 간 및 트레이트 간 중복 보고서에 사용할 수 있습니다.
...
중복 보고서가 백만 개의 레코드 제한에 도달하는 경우 이 보고서에 대한 .csv 파일을 요청할 수 있습니다. &quot;예기치 않은 오류가 발생했습니다&quot;라는 메시지가 표시되면 보고서가 이 제한에 도달했을 수 있습니다. 자체 데이터베이스 시스템에서 가져오고 작업할 수 있는 압축된 .csv 파일을 요청하려면 고객 지원 센터에 문의하십시오. 파일은 세그먼트 간, 세그먼트 간 및 트레이트 간 중복 보고서에 사용할 수 있습니다.
...
<table id="table_C99FCABA365B4AB99620F27D4414E623"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>겹치는 보고서 파일은 gzip 압축되어 있으며 <code> .gz</code> 파일 확장명. 다음을 추가해야 합니다. <code> .csv</code> 압축을 푼 후에 파일에 대한 확장입니다. </p> </td> 
  </tr> 
  <tr> 
...
다음에 대한 데이터 파일 [세그먼트-세그먼트 중복 보고서](segment-segment-overlap-report.md) 에는 다음 레코드가 포함되어 있습니다.
...
<table id="table_1BDC7019DF2543069D7AE229C5E2454E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>7일 및 30일 룩백 간격에 대한 보고서를 가져올 수 있습니다. 다음 <code> rangeid</code> 은 아래에 표시된 시간 간격에 해당합니다. </p> <p> 
...
다음에 대한 데이터 파일 [세그먼트-특성 중복 보고서](segment-trait-overlap-report.md) 에는 다음 레코드가 포함되어 있습니다.
...
다음에 대한 데이터 파일 [특성-특성 중복 보고서](trait-trait-overlap-report.md) 에는 다음 레코드가 포함되어 있습니다.
