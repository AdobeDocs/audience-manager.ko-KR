...
클릭 추적은 타사 크리에이티브를 위한 클릭 기반 활동을 기록하므로 캠페인 전체에서 방문자 참여를 측정할 수 있습니다. [노출 횟수 컬렉션](/help/using/integration/media-data-integration/impression-data-pixels.md)과 유사하게, 처리를 위해 이벤트 호출이 [!DNL Audience Manager] 데이터 수집 서버([!DNL DCS])로 전송됩니다. 그런 다음 방문자는 의도한 웹 주소로 리디렉션됩니다.
...
<table id="table_6EB65C3B7D0E49C59AA6C932549E33FC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>광고주 ID.</p> <p>광고주의 데이터 소스에 대한 통합 코드입니다. Audience Manager 데이터 소스는 관련이 없습니다.</p> <p> <span class="wintitle"> Audience Optimization</span> 보고서에 필요합니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>데이터 공급자 ID. </p> <p>데이터 공급자 ID를 사용자 ID에 연결하는 데 종종 <code> d_dpuuid</code>과 함께 사용됩니다. </p> <p>선택 사항입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> d_dpuuid</code> </p> </td> 
   <td colname="col02"> <p> <code> %d_dpuuid%</code> </p> </td> 
   <td colname="col2"> <p>데이터 공급자가 제공한 고유 사용자 ID. </p> <p>사용자 ID를 데이터 공급자 ID에 연결하는 데 종종 <code> d_dpid</code>과 함께 사용됩니다. </p> </td> 
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>요청을 제공하는 DCS 클러스터의 숫자 영역 ID. DCS에 대한 자세한 내용은 <a href="../../reference/system-components/components-data-collection.md"> 데이터 수집 구성 요소</a>를 참조하십시오. </p> <p>선택 사항입니다. </p> </td> 
  </tr> 
  <tr> 
