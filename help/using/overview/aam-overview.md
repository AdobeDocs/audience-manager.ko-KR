...
landing-page-description: Audience Manager 기록, 수집된 데이터 유형, 세분화, 보고 등에 대한 정보입니다.
short-description: Audience Manager 기록, 수집된 데이터 유형, 세분화, 보고 등에 대한 정보입니다.
...
Audience Manager를 사용하면 데이터 판매자, 교환 또는 수요 측 플랫폼에 연결되지 않습니다. 또한 Audience Manager은 파트너의 데이터 자산과 관련하여 완전히 불가지론자적 태도를 갖습니다. Audience Manager은 여러 데이터 소스에 대한 액세스를 통해 디지털 게시자에게 광범위한 타사 데이터를 사용할 수 있는 기능을 제공합니다. Adobe의 파트너 솔루션팀에 문의하여 타깃 대상자에 대한 정확하고 스마트한 결정을 내리는 데 도움을 받으십시오.

## 데이터 관리 플랫폼(DMP)의 세 가지 기능 {#dmp-three-functions}

DMP(데이터 관리 플랫폼)의 기능은 아래와 같이 세 가지 범주로 요약할 수 있습니다.

![세 가지 DMP 기능 이미지: 데이터 입력, 대상자 만들기, 데이터 출력](/help/using/overview/assets/dmp-functions.png)
...
데이터를 대상자 프로필에 통합하여 다양한 장치와 채널에서 완전한 고객 보기를 제공합니다. 유사 모델을 만들고, 대상자 세그먼트와 프로필 그룹을 만들고, 제2자 데이터 및 타사 데이터 소스로 보완합니다.

**데이터 출력**

DSP(수요 측 플랫폼), 캠페인 관리 시스템 및 기타 마케팅 플랫폼으로 대상자 세그먼트를 푸시하여 활성화합니다.
