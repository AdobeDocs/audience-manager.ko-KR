...
서버 간(서버 간) 대상에 대한 세그먼트만 추가 또는 편집할 수[!DNL S2S]있습니다. [!UICONTROL [!DNL S2S] 대상 빌더]로 대상을 만들 [수 없습니다](/help/using/features/destinations/destination-builder.md). 목적지를 설정하려면 컨설턴트에게 [!DNL S2S] 문의하십시오. 대상에 대한 세그먼트를 추가하거나 편집하려면 다음 지침에 [!DNL S2S] 따릅니다.

<!-- destination-s2s-edit.xml -->

대상에 대한 세그먼트 매핑을 추가 또는 [!DNL S2S] 편집하려면:

1. 로 **[!UICONTROL Audience Data > Destinations]**&#x200B;이동합니다. [ **통합 Platform] > [장치 기반** ]을 선택하고 작업할 [!DNL S2S] 대상을 찾습니다.
