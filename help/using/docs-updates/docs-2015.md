  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D4F6BB8E192E4C1BAF1B505541A1E56E"> 
      ...
      <li id="li_85A63519222A4423B8D7A3FF90929741"><code> declaredId</code> 변수에 메모를 추가했습니다. 방문자 ID 서비스를 사용하는 경우 ID를 DIL 대신 <code> setCustomerIDs</code>(으)로 설정하십시오. <a href="https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html?lang=ko" format="https" scope="external"> 고객 ID 및 인증 상태</a>를 참조하십시오. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
