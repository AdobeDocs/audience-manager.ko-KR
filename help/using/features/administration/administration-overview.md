...
메뉴 아래의 옵션을 사용하면 Audience Manager 사용자를 만들고 그룹에 할당할 수 [!UICONTROL Administration] 있습니다. 한도(트레이트, 세그먼트, 대상 및 모델)를 볼 수도 있습니다.
...
사용자를 만들고 사용자 세부 사항 [!DNL Audience Manager] 과 로그인 상태를 지정하고 사용자를 그룹에 지정합니다.
...
1.  [!UICONTROL Group Details]:
   * 그룹 이름을 지정합니다.
   * 간단한 그룹 설명을 제공합니다.
1. 에서 옵션 [!UICONTROL Group Members]에서 사용자를 **[!UICONTROL Add Users]** 클릭하여 그룹에 추가합니다.
1. 에서 [!UICONTROL Group Permissions]특성, [세그먼트](../../features/traits/trait-details-page.md), [세그먼트](../../features/segments/segments-purpose.md)또는 [에서](../../features/destinations/destinations.md) 대상 **[!UICONTROL Add Object]**을선택합니다.
