...
<table id="table_9017F44983CC49E888BE3470430D7ACB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>테스트 그룹에 대한 새 검색 및 필터링 기능을 포함하도록 설명서를 업데이트했습니다. 다음을 참조하십시오. <a href="../features/audience-lab/audience-lab.md#search-and-filter"> 테스트 그룹 검색 및 필터링</a> 섹션. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md"> 대응 가능 대상 설명서 개선 사항</a> </p> </td> 
...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Audience Manager 및 Adobe Analytics을 사용하는 고객의 경우: Audience Manager 사용자 인터페이스에서는 Analytics 보고서 세트에서 자동으로 생성된 데이터 소스를 삭제할 수 없습니다. 사용 <a href="https://experienceleague.adobe.com/docs/core-services/interface/about-core-services/core-services-landing.html" format="https" scope="external"> 핵심 서비스</a> 를 클릭하여 이러한 데이터 소스의 매핑을 해제합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>버전 8.0부터 <span class="wintitle"> DIL</span> 은(는) 다음에 대한 엄격한 종속성을 가지고 있습니다. <a href="https://experienceleague.adobe.com/docs/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform ID 서비스</span></a>, 버전 3.3 이상 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md">DIL(데이터 통합 라이브러리) 이해</a> </p> </td> 
   <td colname="col2"> <p>수정됨 <a href="../dil/dil-overview.md"> DIL 코드 가져오기 및 구현</a> ...이라는 사실에 참작하다 <span class="keyword"> Adobe Experience Platform Launch</span> 는 의 기본 코드 배포 도구입니다. <span class="keyword"> Experience Cloud</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><a href="../dil/dil-class-overview/dil-create.md#dil-create"> DIL 만들기</a> </td> 
   <td colname="col2"> <p>다음 요소는 다음부터 사용되지 않습니다. <span class="wintitle"> DIL</span> 2018년 8월 릴리스된 8.0: </p> <p> 
...
<table id="table_9166897029124C6782E0DE3D816CEA49"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>사용자는 약 4시간 후에 규칙 기반 트레이트에 대한 자격이 시작됩니다 <a href="../features/traits/create-onboarded-rule-based-traits.md#create-rules-based-or-onboarded-traits"> 트레이트 만들기</a> UI에서 트레이트 자격에 대한 자세한 내용은 문서를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
