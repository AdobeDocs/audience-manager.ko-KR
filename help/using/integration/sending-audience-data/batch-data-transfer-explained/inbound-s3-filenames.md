...
데이터를 보낼 때 따라야 하는 필수 필드, 구문, 이름 지정 규칙 및 파일 크기에 대해 설명합니다 [!DNL Audience Manager]. 데이터를 [!DNL Audience Manager] / [!DNL Amazon S3] 디렉토리.
...
<table id="table_455D174BAB9B494D973DA1023F22B962"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>사용하는 회사 또는 조직 이름 <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>정수. 큰 파일을 여러 부분으로 분할할 때 사용하여 처리 시간을 향상시킬 수 있습니다. 숫자는 원본 파일을 보내는 부분을 가리킵니다. </p> <p>효율적인 파일 처리를 위해 표시된 대로 데이터 파일을 분할합니다. </p> 
    ...
    </ul> <p>처음 2를 참조하십시오 <a href="../../../integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md#file-name-examples"> 파일 이름 예</a> 아래의 제품에서 사용할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> [.gz]</code> </p> </td> 
   <td colname="col2"> <p>Amazon S3로 파일을 보낼 때는 gzip 압축만 사용합니다. 압축하면 이러한 파일이 <code> .gz</code> 확장. .zip 압축을 사용하지 마십시오. </p> <p>압축된 파일은 3GB 이상이어야 합니다. 파일이 더 큰 경우 고객 지원 센터에 문의하십시오. Audience Manager이 대용량 파일을 처리할 수 있지만 파일 크기를 줄이고 데이터 전송을 보다 효율적으로 수행할 수 있습니다. <a href="../../../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-compression.md">인바운드 데이터 전송 파일에 대한 파일 압축</a>을 참조하십시오. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
다음을 수행할 수 있습니다 [다운로드](assets/ftp_dpm_1234_1445374061.overwrite) 추가 예를 보려면 샘플 파일을 사용하십시오. 이 파일은 `.overwrite` 파일 확장명을 사용합니다. 간단한 텍스트 편집기로 엽니다.

## 허용되는 파일 크기 {#accepted-file-sizes}

파일을 가장 빨리/가장 빨리 처리하기 위해서는 아래 그림과 로 데이터를 보낼 때 파일 크기 제한을 고려하십시오 [!DNL Audience Manager] / [!DNL Amazon S3] 디렉토리.
