...
| 주제 | 설명 |
|----|----|
| [Predictive Audiences](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**예측 대상 모델 복제**:이제 기존 모델을 복제하고 필요에 따라 구성을 변경할 수 있습니다. 자세한 내용은 [예측 대상 모델](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) 복제 및 편집을 참조하십시오.</li><li>**예측 대상 일괄 분류**:예측 대상은 실시간으로 개별 성향으로 방문자를 분류하는 것 외에도 배치 분류를 지원하므로 온보드 사용자를 분류하고 배치 대상으로 활성화할 수 있습니다.</li></ul> |
| [보고서 겹치기](/help/using/reporting/dynamic-reports/dynamic-reports.md) | 겹치기 보고서(트레이트 대 트레이트[,](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md)세그먼트 대 트레이트 [,](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md)세그먼트 대 세그먼트 [)를 계산하는 데 사용하는 방법을 업데이트했습니다](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md). 겹치기 보고서 계산은 이제 보고 고유 및 MinHash 서명( [1/54 데이터 샘플링](/help/using/reporting/report-sampling.md#data-sampling-ratio)대신)을 기반으로 합니다. |
