---
description: 2016년 릴리스된 새로운 및 수정된 Audience Manager 설명서 목록입니다. Experience Cloud 릴리스 노트에 포함되지 않았을 수 있는 Audience Manager 안내서의 일부 업데이트 또는 변경 내용이 포함되어 있습니다.
seo-description: 2016년 릴리스된 새로운 및 수정된 Audience Manager 설명서 목록입니다. Experience Cloud 릴리스 노트에 포함되지 않았을 수 있는 Audience Manager 안내서의 일부 업데이트 또는 변경 내용이 포함되어 있습니다.
...
2016년 릴리스된 새로운 및 수정된 Audience Manager 설명서 목록입니다. Experience Cloud 릴리스 노트에 포함되지 않았을 수 있는 Audience Manager 안내서의 일부 업데이트 또는 변경 내용이 포함되어 있습니다.
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>화이트 리스트 Audience Manager <span class="keyword"></span> IP 및 FTP 주소에 대한 새 항목이 포함되어 있습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Google의 범용 Analytics에서 <span class="keyword"> Audience Manager</span> 로 데이터를 전송할 수 있는 새로운 DIL 방법을 설명하는 문서입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>전체 <span class="keyword"> Audience Manager</span> ID 목록은 이 문서를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/help/ko-KR/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Experience Cloud에 사용된 쿠키</a> </td> 
   <td colname="col2"> 프랑스어 CNIL 규정을 준수하기 위해 demdex 쿠키와 파트너 쿠키의 TTL(time-to-live) 값을 180일로 수정했습니다. </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> 플랫폼 수준 키로 장치 타겟팅 </a> </td> 
   <td colname="col2"> <p>Audience Manager 계정의 모든 속성에 장치 관련 변수가 있는 사용자를 타게팅하는 데 사용할 수 있는 공통 플랫폼 수준 키-값 쌍을 설명하는 새 문서입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Audience Manager 세그먼트를 실시간으로 Analytics과 공유할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>가입자의 피드를 <span class="wintitle"> Audience Marketplace</span> 데이터 공급자가 비활성화하는 방법을 설명합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">공급자가 내 데이터 피드를 비활성화하면 어떻게 됩니까?</a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Audience Marketplace <span class="wintitle"></span> 청구 보고서의 항목을 나열하고 정의하는 새 설명서입니다. </p> </td> 
  </tr> 
  <tr> 
