...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> 쿠키가 Experience Cloud에서 사용됨</a> </td> 
   <td colname="col2"> 프랑스 CNIL 규정을 준수하도록 demdex 쿠키 및 파트너 쿠키의 TTL(time-to-live) 값을 180일로 수정했습니다. </td> 
  </tr> 
  <tr> 
