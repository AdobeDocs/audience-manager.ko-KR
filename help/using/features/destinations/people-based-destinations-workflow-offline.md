...
>[!IMPORTANT]
>
> 계속하기 전에 탑승하려는 고객 활동이 해당 온보딩 트레이트와 함께 Audience Manager에 이미 정의되어 [있는지 확인하십시오](../traits/trait-and-segment-qualification-reference.md).
...
아래 표에서 해당 온보드 트레이트 ID에 대한 고객 ID의 자격을 얻고자 합니다. DPUUID가 [ID 9999의 데이터 소스에](../../reference/ids-in-aam.md) 저장되고 Audience Manager 파트너 ID가 123인 것으로 간주합니다.
...
1. Audience Manager 계정에 로그인하고 **[!UICONTROL Audience Data]** -> **[!UICONTROL Data Sources]**&#x200B;으로 이동한 다음 을 클릭합니다 **[!UICONTROL Add New]**.
