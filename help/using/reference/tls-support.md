...
2019년 3월에 [!DNL Adobe]에서 [!DNL TLS 1.0] 프로토콜에 대한 지원을 종료했습니다. [!DNL TLS 1.0]만 지원하는 브라우저를 사용하는 최종 사용자에게는 Adobe Audience Manager 기능이 작동하지 않습니다.

2020년 3월에 [!DNL Adobe]에서 [!DNL TLS 1.1] 프로토콜에 대한 지원을 종료합니다. [!DNL TLS 1.1]만 지원하는 브라우저를 사용하는 최종 사용자에 대해 Adobe Audience Manager 기능이 작동하지 않습니다.

Adobe은 작성 시 최신 버전의 프로토콜을 사용하는 [!DNL TLS 1.2]을(를) 적극 권장합니다. 모든 최신 브라우저는 [!DNL TLS 1.2]을(를) 사용합니다. 브라우저, 버전 및 해당 [!DNL TLS] 지원 목록을 수집했습니다. TLS 브라우저 지원에 대한 자세한 내용은 [전송 계층 보안 Wikipedia 링크](https://en.wikipedia.org/wiki/Transport_Layer_Security#Web_browsers)를 참조하십시오.
