...
[!UICONTROL Profile Merge Rules]을(를) 사용하여 작업할 때는 [!UICONTROL Adobe Experience Platform Identity Service] 및 [DIL](../../dil/dil-overview.md)의 최신 버전을 사용하는 것이 좋습니다. 그러나 이 기능을 사용하기 위해 [!UICONTROL Adobe Experience Platform Identity Service]을(를) 사용할 필요는 없습니다. [!UICONTROL DIL]을(를) 사용하고 있다면 아래의 [레거시 DIL 섹션](#legacy-dil)을 참조하세요.
