...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Audience Manager 및 Adobe Analytics를 사용하는 고객의 경우Audience Manager UI에서는 Analytics 보고서 세트에서 자동으로 생성된 데이터 소스를 삭제할 수 없습니다. 핵심 서비스를 <a href="https://marketing.adobe.com/resources/help/ko_KR/mcloud/" format="https" scope="external"> 사용하여</a> 이러한 데이터 소스를 매핑을 해제합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Starting with version 8.0, <span class="wintitle"> DIL</span> has a hard dependency on the <a href="https://marketing.adobe.com/resources/help/ko_KR/mcvid/" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, version 3.3 or higher. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_F2018CE3F64E4A1FAA9289EEA17D4E4D"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-and-segment-qualification-reference.md#unique-trait-realizations"> 고유 트레이트 실현과 총 트레이트 인구</a> </p> </td> 
