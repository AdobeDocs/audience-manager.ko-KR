...
4. IAB TCF v2.0과 통합되고 IAB TCF에 등록되어 있는 CMP(Consent Management Library)를 사용하거나 자체 CMP를 사용해야 합니다. [IAB 프레임워크 내에 등록된 CMP](https://iabeurope.eu/cmp-list/) 목록을 참조하십시오.
