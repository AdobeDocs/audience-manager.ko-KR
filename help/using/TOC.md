...
+ 기능{#features}
   ...
   + Audience Lab{#audience-lab}
      + [Audience Lab 개요](features/audience-lab/audience-lab.md)
   ...
   + 데이터 탐색기{#data-explorer}
      ...
      + [신호에서 특징 만들기](features/data-explorer/create-traits-from-signals.md)
      + [특성 특성 채우기](features/data-explorer/data-explorer-trait-backfill.md)
      + [지원되는 논리 연산자](features/data-explorer/data-explorer-supported-operators.md)
   + [데이터 내보내기 제어](features/data-export-controls.md)
   + 데이터 소스 {#data-sources}
      + [Data Sources 목록 및 설정](features/datasources-list-and-settings.md)
   ...
   + 프로필 병합 규칙{#profile-merge-rules}
      ...
      + [프로필 병합 규칙 및 장치 해제 프로세스](features/profile-merge-rules/merge-rule-unsegment.md)
   ...
   + 세그먼트{#segments}
      ...
      + [일시 중지되거나 삭제된 세그먼트](features/segments/paused-deleted-segments.md)
   ...
   + 트레이트{#traits}
      ...
      + [활성 고객 특성 및 데이터 소스 동기화 특성](features/traits/client-activity-synced-audience-traits.md)
      + [폴더 특성: about](features/traits/about-folder-traits.md)
      + [폴더 특성 관리](features/traits/manage-folder-traits.md)
      + 특성 빌더{#trait-builder}
         + [특성 빌더 정보](features/traits/about-trait-builder.md)
         + [규칙 기반 또는 온보드 트레이트를 만듭니다.](features/traits/create-onboarded-rule-based-traits.md)
         ...
         + [트레이트 빌더에서의 작업 순서](features/traits/trait-operator-precedence.md)
         + [트레이트 빌더에서 정규 표현식 사용](features/traits/trait-builder-regex.md)
      + [트레이트 스토리지](features/traits/trait-storage.md)
      + [정확성 및 전달 범위](features/traits/trait-accuracy-reach.md)
      + [일반적인 분류 방식을 사용하여 트레이트화 분류](features/traits/trait-common-taxonomy.md)
      + [주요 변수의 이름 요구 사항](features/traits/trait-key-name-requirements.md)
      + [세그먼트와 트레이트 시간 설명](features/traits/segment-ttl-explained.md)
      + [주요 변수의 접두사 요구 사항](features/traits/trait-variable-prefixes.md)
      + [플랫폼 수준 키가 포함된 지리 기반의 타깃팅](features/traits/trait-geotarget-keys.md)
...
+ 보고{#reporting}
   ...
   + 고객 최적화 보고서 {#audience-optimization-reports}
      ...
      + Audience Optimization for Advertisers {#audience-optimization-advertisers}
         ...
         + [세그먼트 성능 보고서](reporting/audience-optimization-reports/aor-advertisers/segment-performance.md)
      ...
      + 게시자를 위한 Audience Optimization{#audience-optimization-publishers}
         ...
         + [사용하지 않은 주요 특징](reporting/audience-optimization-reports/aor-publishers/publisher-top-unused-traits.md)
   ...
   + 대화형 및 오버랩 보고서 {#interactive-and-overlap-reports}
      ...
      + [사용되지 않는 신호 보고서](reporting/dynamic-reports/unused-signals.md)
...
+ API 및 SDK 코드{#api-and-sdk-code}
   ...
   + DCS (Data Collection Server) API 메서드 및 코드{#dcs}
      ...
      + DCS API 참조{#dcs-api-reference}
         ...
         + [ID 모니터링 및 블랙 리스트](api/dcs-intro/dcs-api-reference/id-monitoring-blacklisting.md)
   ...
   + REST API{#rest-apis}
      ...
      + [REST API 시작하기](api/rest-api-main/aam-api-getting-started.md)
...
+ 구현 및 통합 안내서{#implemenation-integration-guides}
   ...
   + 대상 데이터 전송{#sending-audience-data}
      ...
      + 일괄 데이터 전송 프로세스{#batch-data-transfer-process}
         ...
         + [인바운드 데이터 파일 컨텐츠: 구문, 잘못된 문자, 변수 및 예제](integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md)
         + [인바운드 데이터 파일에 대한 Amazon S 3 이름 및 파일 크기 요구 사항](integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md)
...
+ 참조{#reference}
   ...
   + [Amazon S 3: about](reference/amazon-s3.md)
   + [광고주 활용 사례](reference/advertiser-use-cases.md)
   ...
   + 일괄 관리 툴{#bulk-management-tools}
      ...
      + [벌크 제작](reference/bulk-management-tools/bulk-create.md)
      + [Bulk estimate](reference/bulk-management-tools/bulk-estimates.md)
      ...
      + [일괄 관리 도구에 대한 문제 해결 팁](reference/bulk-management-tools/bulk-troubleshooting.md)
...
+ 설명서 업데이트{#documentation-updates}
   + [2019 년 설명서 업데이트](docs-updates/docs-2019.md)
   + [2018 년 설명서 업데이트](docs-updates/docs-2018.md)
   + [2017 년 설명서 업데이트](docs-updates/docs-2017.md)
   + [2016 년 설명서 업데이트](docs-updates/docs-2016.md)
   + [2015 년 설명서 업데이트](docs-updates/docs-2015.md)
