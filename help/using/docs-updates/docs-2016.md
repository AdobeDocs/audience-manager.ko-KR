---
description: 2016년에 출시된 신규 및 수정된 Audience Manager 설명서 목록. Experience Cloud 릴리스 노트에 포함되지 않았을 수 있는 Audience Manager 안내서의 작은 업데이트 또는 변경 사항이 포함되어 있습니다.
...
2016년에 출시된 신규 및 수정된 Audience Manager 설명서 목록. Experience Cloud 릴리스 노트에 포함되지 않았을 수 있는 Audience Manager 안내서의 작은 업데이트 또는 변경 사항이 포함되어 있습니다.
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 알고리즘 검색 프로세스에 추가 단계가 설명되어 있습니다. 이 단계에서는 여러 데이터 처리 주기에 대한 알고리즘 트레이트의 진화에 대해 설명합니다. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/report-sampling.md"> 선택한 Audience Manager 보고서의 데이터 샘플링 및 오류율... </a> </p> </td> 
   <td colname="col2"> <p>새로운 정보와 명확성과 스타일을 포함하도록 수정되었습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../dil/dil-use-cases.md#traffic-dil-gtm"> Google 태그 관리자(GTM)의 트래픽 DIL </a> </p> </td> 
   <td colname="col2"> <p>2016년 5월에 Google 업데이트가 있으면 태그의 사용자 지정 HTML 섹션에 DIL 코드를 로드할 수 있습니다. 더 이상 코드를 원격으로 호스팅할 필요가 없습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>중복 보고서가 백만 개의 레코드 제한에 도달하는 경우 이 보고서에 대한 .csv 파일을 요청할 수 있습니다. 파일은 세그먼트 간, 세그먼트 간, 트레이트 간 및 트레이트 간 중복 보고서에 사용할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../dil/dil-modules.md#ga-submit-universal-analytics"> GA.submitUniversalAnalytics </a> </p> </td> 
   <td colname="col2"> <p>로 데이터를 보낼 수 있는 새로운 DIL 방법을 설명하는 설명서입니다 <span class="keyword"> Audience Manager</span> Google의 유니버설 애널리틱스 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> 방문자 ID 인증 상태를 처리합니다 <code> UNKNOWN</code> 및 <code> LOGGED_OUT</code> 같은 방법으로 이 문서에서는 처리 방법에 대한 자세한 정보를 제공합니다 <code> setCustomerID</code> 이벤트 호출. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../reference/cid.md"> CID가 DPID 및 DPUUID 대체 </a> </td> 
   <td colname="col2"> 이제 모바일 식별자 데이터 소스에 고객 ID 통합 코드를 사용할 수 있습니다. Android 장치용 DSID_20914 CID_IC 및 iOS 장치용 DSID_20915 CID_IC를 사용합니다. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/ids-in-aam.md"> Audience Manager의 ID 색인 </a> </p> </td> 
   <td colname="col2"> <p>의 전체 목록은 이 문서를 참조하십시오 <span class="keyword"> Audience Manager</span> ID. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>시간 간격이 작동하는 방식을 설명하는 새 콘텐츠입니다 <span class="wintitle"> 대응 가능 대상</span> 및 <span class="wintitle"> 대상</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>의 기능을 설명하는 새 콘텐츠입니다 <span class="wintitle"> 대상</span> 랜딩 페이지. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">OAuth 2.0 프로토콜을 통해 실시간 아웃바운드 데이터 전송을 보호하는 기능이 추가되었습니다. 다음 사항에 문의하십시오. <span class="keyword"> Adobe Audience Manager</span> 시작할 컨설턴트입니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>고객에게 DCM 계정 관리자와 함께 파일 형식을 확인할 것을 알리는 메모를 추가했습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../dil/dil-modules.md#ga-init"> GA.init </a> </p> </td> 
   <td colname="col2"> <p>다음 사항을 수정했습니다. <code> GA.init()</code> 는 Google의 최신 버전의 analytics 코드에서 작동하지 않습니다. <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/amazon-s3.md"> Amazon S3: 설명 </a> </p> </td> 
   <td colname="col2"> <p>일괄 아웃바운드 데이터 전송을 위한 Encryption-at-rest 가 추가되었습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/profile-merge-rules/merge-rule-definitions.md"> 정의된 프로필 병합 규칙 옵션 </a> </p> </td> 
   <td colname="col2"> <i>이 기능은 더 이상 사용되지 않습니다.</i><p>수정된 내용은 <span class="keyword"> Adobe Experience Cloud Device Co-op</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 프랑스 CIL 규정을 준수하도록 demdex 쿠키의 및 파트너 쿠키의 TTL(time-to-live) 값을 180일로 수정했습니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2">의 일반적인 개요 <span class="wintitle"> 데이터 정보 라이브러리</span> (DIL). </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>부 수정 사항 및 컨텐츠 재구성입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/aam-time-zones.md"> Audience Manager의 시간대 </a> </p> </td> 
   <td colname="col2"> <p> Audience Manager은 전체 UI에서 UTC(Coordinated Universal Time)를 사용합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/api-swagger-migration.md"> API 코드 마이그레이션 </a> </p> </td> 
   <td colname="col2"> <p>세그먼트 테스트 그룹 API 및 데이터 피드 요청 API에 대한 링크가 추가되었습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>인덱스에 새 고객 대면 오류 코드를 추가했습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>DIL이 을 사용하는 이유를 설명하는 콘텐츠가 업데이트되었습니다 <code> GET</code> 및 <code> POST</code> 이벤트 호출에서 데이터를 전송하는 메서드입니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>UI 재디자인에 대한 설명서가 수정되었습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/bulk-management-tools/bulk-management-intro.md"> 벌크 관리 시작 </a> </p> </td> 
   <td colname="col2"> <p>새로운 벌크 관리 템플릿 v0.4.2를 다운로드할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/audience-optimization-reports/audience-optimization-reports.md"> 대상 최적화 보고서</a> </p> </td> 
   <td colname="col2"> <p>업데이트 날짜: <span class="wintitle"> Audience Optimization</span>크로스 채널 전환, 역할 기반 액세스 제어, 전환 그룹 및 보고된 전환 트레이트 보고서가 있는 보고서. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>다음 <span class="wintitle"> 채널 간 전환</span> 옵션 <span class="wintitle"> Audience Optimization</span> 보고서를 사용하면 오프라인 전환을 제공된 온라인 노출 또는 클릭에 표시할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> 플랫폼 수준 키로 장치 타겟팅 </a> </td> 
   <td colname="col2"> <p>Audience Manager 계정의 모든 속성에서 장치 관련 변수를 사용하여 사용자를 타깃팅하는 데 사용할 수 있는 일반적인 플랫폼 수준 키-값 쌍을 설명하는 새 문서입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>제거됨 <span class="keyword"> Audience Manager</span> 2017년 9월 설명서 이동 <span class="keyword"> Analytics</span> 설명서. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 픽셀 호출을 통해 캠페인 노출 횟수 데이터 캡처 </a> </p> </td> 
   <td colname="col2"> <p>을 사용하여 모바일 ID 전달을 포함하도록 업데이트됨 <code> d_cid</code>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>대시보드에 새 병합 규칙 카드를 표시하도록 수정했습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/profile-merge-rules/merge-rule-definitions.md"> 정의된 프로필 병합 규칙 옵션 </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html" format="https" scope="external"> Analytics의 Audience Manager 세그먼트</a> </p> </td> 
   <td colname="col2"> <p>Analytics와 실시간으로 Audience Manager 세그먼트를 공유할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/destinations/destinations.md"> 대상 </a> </p> </td> 
   <td colname="col2"> <p>개정 버전에는 대상 문서의 컨텐츠와 조직에 중요한 변경 사항이 적용됩니다. 이러한 변경 사항은 복잡성을 줄이고 쿠키 및 URL 대상 워크플로우를 보다 명확하게 하도록 설계되었습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>명명된 새 연산자인 <code> Matcheswords</code>. 정규 표현식을 사용하지 않고 일치하는 단어 패턴을 지정할 수 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>방법에 대해 설명합니다. <span class="wintitle"> Audience Marketplace</span> 데이터 공급자는 가입자의 피드를 비활성화합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">공급자가 내 데이터 피드를 비활성화하면 어떻게 됩니까?</a> </p> </td> 
   <td colname="col2"> <p>다음 내용을 설명합니다. <span class="wintitle"> Audience Marketplace</span> 데이터 구매자는 공급자가 데이터 피드에 대한 액세스를 취소한 경우 예상할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS 오류 코드, 메시지 및 예제 </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>명확성을 향상시키기 위해 컨텐츠가 수정되었습니다. 파일 이름 및 파일 컨텐츠 ID가 서로 매핑되는 방식에 대한 새로운 섹션을 추가했습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이 기능에 액세스하려면 관리자 권한이 있어야 한다는 참고가 추가되었습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../dil/dil-class-overview/dil-create.md#dil-create"> DIL 만들기 </a> </p> </td> 
   <td colname="col2"> <p>수정된 텍스트 <code> declaredId</code>. 고객 ID를 인코딩 해제된 값으로만 전달해야 합니다. 인코딩 ID는 이중으로 인코딩된 식별자를 만듭니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-s2s/dcs-s2s-calls.md"> 서버 간 DCS API 호출 만들기</a> </p> </td> 
   <td colname="col2" morerows="1"> <p>를 포함하도록 텍스트가 수정되었습니다. <code> d_mid</code> 변수를 채우는 방법을 설명합니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 픽셀 호출을 통해 캠페인 노출 횟수 데이터 캡처 </a> </p> </td> 
   <td colname="col2"> <p>에 대한 새 키 및 매크로 항목이 추가되었습니다. <code> d_mid</code> 및 <code> d_region</code>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>에 대한 새 설명이 추가되었습니다 <span class="wintitle"> 이벤트 유형</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>구매자의 가입 상세내역 페이지에 표시된 계획 정보를 설명하는 신규 문서 </p> </td> 
  </tr> 
 </tbody> 
</table>
