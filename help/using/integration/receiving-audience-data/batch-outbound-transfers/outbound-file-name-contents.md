...
<table id="table_1EA97D75004148CE85F702427DB7E97A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>대상 ID. </p> <p>Audience Manager에서 대상 <span class="keyword"> </span>은 타깃팅 가능한 세그먼트를 매핑할 수 있는 통합 인스턴스입니다. 고객은 비즈니스 요구 사항에 따라 여러 대상을 가질 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>동기화 모드는 동기화 유형에 따라 파일 이름에 레이블을 추가하는 매크로 자리 표시자입니다. 동기화 유형에는 전체 및 증분 유형이 포함됩니다. 파일 이름에 <code> iter </code> 또는 로 표시됩니다 <code> full </code>. </p> 
...
파일 내용이 포함된 파일 [!DNL Amazon S3] 을 *`PID_ALIAS="XYZCustomer"`* 위치 [!DNL Google Advertiser IDs] 로 전송할수 있습니다.
...
파일 컨텐츠 없이 [!DNL FTP] 위치 *`PID_ALIAS`* 로 파일을 전송할 [!DNL Apple Advertiser IDs] 수 있습니다.
...
**시나리오 3**: 파일 내용 [!DNL FTP] 에서 타사 사용자 ID와 함께 *`PID_ALIAS="XYZCustomer"`* *`Vendor ID=45454`*&#x200B;위치로 보내진 파일():
...
<table id="table_109BA747CFDA40108370EFEB208C7E11"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Audience Manager에서 할당한 고유한 사용자 ID <span class="keyword"> </span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>사용자가 실격 처리된 세그먼트 ID입니다. 여러 세그먼트를 쉼표로 구분합니다. 전체 동기화를 사용하면 데이터 파일에 사용자의 현재 세그먼트 전체 목록이 포함되므로 제거된 세그먼트를 무시할 수 있습니다. 일반적으로 사용자가 제거된 세그먼트가 아닌 사용자가 속한 세그먼트에 대해 알고 싶을 수 있습니다. See also <a href="../../../integration/receiving-audience-data/batch-outbound-transfers/outbound-file-name-contents.md#outbound-data-file-name-syntax-and-examples"> Outbound Data File Name: Syntax and Examples </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
