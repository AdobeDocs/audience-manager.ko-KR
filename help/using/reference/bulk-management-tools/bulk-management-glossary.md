...
<table id="table_2C2BC2FB3EFC443C9A5AE18EFC6FABFD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>신호는 사용자 활동에 따라 <span class="keyword"> Audience Manager</span>에 전달된 데이터 비트입니다. 이러한 값은 <a href="../../reference/key-value-pairs-explained.md"> 키-값 쌍</a>으로 전송됩니다. 소스 키는 변경되지 않는 상수입니다. 변경할 수 있는 소스 값을 분류하는 데 도움이 됩니다. <a href="../../features/derived-signals.md"> 파생 신호</a>를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>세그먼트를 대상에 보낼 수 있는 시기를 나타냅니다. <i>yyyy-mm-dd</i> 형식을 사용합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="term"> targetKey</span> </p> </td> 
   <td colname="col2">파생된 신호에 사용되는 키입니다. <a href="../../features/derived-signals.md"> 파생 신호</a>를 참조하십시오. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="term"> targetValue</span> </p> </td> 
   <td colname="col2"> <p>파생된 신호 키와 함께 전달된 값. <a href="../../features/derived-signals.md"> 파생 신호</a>를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>데이터를 수집하는 데 사용되는 실제 특성 또는 세그먼트 규칙입니다. 벌크 요청은 <a href="../../features/traits/about-trait-builder.md"> 특성 규칙 빌더</a> 또는 <a href="../../features/segments/segment-builder.md"> 세그먼트 규칙 빌더</a>와 함께 <span class="keyword"> Audience Manager</span>에서 만든 규칙을 반환합니다. 또한 이러한 도구를 사용하여 세그먼트를 업데이트하거나 트레이트를 업데이트할 때 규칙을 작성하고 일괄적으로 적용할 수도 있습니다. </p> <p>또한 <a href="../../reference/bulk-management-tools/bulk-rules.md"> 특성 규칙 및 세그먼트 규칙 만들기 또는 업데이트</a>를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
