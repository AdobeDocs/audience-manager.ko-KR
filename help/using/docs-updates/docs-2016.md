...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>화이트 리스트 <span class="keyword"> Audience Manager</span> IP 및 FTP 주소에 대한 새 항목이 포함되어 있습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Google의 Universal Analytics에서 <span class="keyword"> Audience Manager</span>으로 데이터를 전송할 수 있는 새 DIL 방법을 설명하는 문서입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience </span> Manager는 방문자 ID 인증 상태 <code> UNKNOWN</code> 를 같은  <code> LOGGED_OUT</code> 방식으로 처리합니다. 문서는 <code> setCustomerID</code> 이벤트 호출을 처리하는 방법에 대한 자세한 정보를 제공합니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle"> Audience Lab</span> 기능에 대한 FAQ입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/addressable-audiences.md#date-ranges"> 지정 가능 대상 및 대상의 날짜 범위  </a> </p> </td> 
   <td colname="col2"> <p><span class="wintitle"> 지정 가능한 대상</span> 및 <span class="wintitle"> 대상</span>에 대해 시간 간격이 작동하는 방식을 설명하는 새 콘텐츠 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle"> 대상</span> 랜딩 페이지의 기능을 설명하는 새 콘텐츠 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><code> GA.init()</code>이(가) 최신 버전의 Google 분석 코드 <code> analytics.js</code>에서 작동하지 않는다는 점을 수정했습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="keyword"> Adobe Experience Cloud 장치 Co-op</span>에 대한 자세한 정보를 포함하도록 수정되었습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="wintitle"> 데이터 정보 라이브러리</span>(DIL)의 일반 개요입니다. </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>DIL이 <code> GET</code> 및 <code> POST</code> 메서드를 사용하여 이벤트 호출에서 데이터를 보내는 이유를 설명하는 콘텐츠를 업데이트했습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>크로스 채널 전환, 역할 기반 액세스 제어, 전환 그룹 및 보고된 전환 특성 보고서가 있는 <span class="wintitle"> Audience Optimization</span>보고서를 업데이트했습니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle"> Audience Optimization</span> 보고서의 <span class="wintitle"> 크로스 채널 전환</span> 옵션을 사용하면 오프라인 전환을 제공된 온라인 노출 또는 클릭에 연결할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>2017년 9월 Audience Manager<span class="keyword"> 설명서에서 제거되었습니다. </span> <span class="keyword"> Analytics</span> 문서로 이동되었습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 픽셀 호출을 통해 캠페인 노출 횟수 데이터 캡처 </a> </p> </td> 
   <td colname="col2"> <p><code> d_cid</code>과(와) 함께 전달된 모바일 ID를 포함하도록 업데이트되었습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>새 명명된 연산자 <code> Matcheswords</code>가 추가되었습니다. 정규 표현식을 사용하지 않고도 일치하는 단어 패턴을 지정할 수 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">공급자가 내 데이터 피드를 비활성화하면 어떻게 됩니까?</a> </p> </td> 
   <td colname="col2"> <p>공급자가 데이터 피드에 대한 액세스를 폐지할 경우 데이터 구매자가 예상할 수 있는 <span class="wintitle"> Audience Marketplace에 대해 설명합니다.</span> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS 오류 코드, 메시지 및 예제 </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 픽셀 호출을 통해 캠페인 노출 횟수 데이터 캡처 </a> </p> </td> 
   <td colname="col2"> <p><code> d_mid</code> 및 <code> d_region</code>에 대한 새 키 및 매크로 항목이 추가되었습니다. </p> </td> 
  </tr> 
  <tr> 
