...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Starting with version 8.0, <span class="wintitle"> DIL</span> has a hard dependency on the <a href="https://docs.adobe.com/content/help/ko-KR/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, version 3.3 or higher. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md">DIL(데이터 통합 라이브러리) 이해</a> </p> </td> 
   <td colname="col2"> <p>Adobe Experience Platform 실행 <a href="../dil/dil-overview.md"> 이</a> Experience Cloud에서 기본 코드 배포 도구라는 사실을 <span class="keyword"> 설명하기 위해 DIL 코드</span> 가져오기 및 구현이 <span class="keyword"> 수정되었습니다</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_728845C945394BCC8689ACF50EDDB577"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>게시자에 대한 대상 최적화는 소유 및 운영되는 컨텐츠에 있는 Audience Manager 세그먼트에 대한 잠재적인 성과 기회를 식별하는 데 도움이 될 수 있습니다. 이러한 보고서는 고객 최적화 및 수익 창출 기회를 제공하기 위해 로그 수준 캠페인 성과 데이터와 Audience Manager 지표를 통합합니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이 자료에는 GDPR(European General Data Protection Regulation)과 관련하여 당사 고객 및 파트너가 요청하는 가장 일반적인 질문과 Adobe Audience Manager(GDPR)이 데이터 프로세서로서 다양한 GDPR 요구 사항을 해결하는 방법이 포함되어 있습니다. </p> </td> 
  </tr> 
  <tr> 
