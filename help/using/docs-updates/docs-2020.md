...
| [IAB TCF를 위한 Audience Manager 플러그인](../overview/data-security-and-privacy/aam-iab-plugin.md) | Adobe이 Privacy by Design에 주력함에 따라 IAB TCF용 Audience Manager 플러그인을 2020년 6월 10일부터 IAB TCF(Transparency &amp; Consent Framework) 버전 2.0으로 업그레이드하게 되었습니다. IAB TCF용 Audience Manager 플러그인을 구현한 고객이 이 기능을 계속 사용하려면 2020년 8월 15일까지 버전 2.0으로 업그레이드해야 합니다. 2020년 8월 15일 이후에는 버전 1.1이 더 이상 지원되지 않습니다. |
