...
<p>위의 예에서 마지막 세 자리 숫자(001,002,003)는 SPLITNUM 식별자입니다.</p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>10자리, UTC, Unix 타임스탬프. </p> <p>또한 Java 날짜/타임스탬프 서식 지정 규칙을 <code> &lt;TIMESTAMP; format="YYYYMMDDhhmmss"&gt; </code> 따라 형식을 지정할 수 있습니다. </p> </td> 
  </tr>
...
<table id="table_5C6F9678CFF34C5EB67BA1DEA0479F1D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>정적 하드 코딩된 <code> 1 </code> 값으로 반환합니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>목록의 세그먼트 목록을 반환합니다. 다음 선택적 인수를 수락합니다. </p> 
    <ul id="ul_B111AA0D6C18445598A1444B8B7E9325"> 
     <li id="li_8603B40229624856AF1FBC434DB8F16A"> <code> segmentId </code>:세그먼트 ID. 삭제 예정. 활동을 만들려면 <code> sid </code>. </li> 
     <li id="li_1EF40DDCA3C5447586904CF021D8F912"> <code> csegid </code>:고객 세그먼트 ID. 삭제 예정. 활동을 만들려면 <code> sid </code>. </li> 
     <li id="li_D85F0A5D16AE4DAFB55C17DBB35EA66E"> <code> sid </code>:세그먼트 ID </li> 
     <li id="li_9BE103EFD8384464B46FAC00422431DB"> <code> type </code>:데이터를 세그먼트 데이터로 식별하는 정적 하드 코딩된 <code> 5 </code>값인 값을 반환합니다. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>정적 하드 코딩된 값으로 <code> 1 </code>반환합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> SYNC_MODE </code> </p> </td> 
   <td colname="col2"> <p>동기화 유형을 나타내며 다음을 포함합니다. </p> 
    ...
    <ul id="ul_E9CDC4DD47B9435086FF42143D9E8177"> 
     <li id="li_4BBC57F0D7874F8EA8C6D39DB3572257"> <code> type </code>:트레이트 유형을 숫자 ID로 식별합니다. 반환: 
      <ul id="ul_D2357E6CF47B4EBC8D3772D17B2EADA3"> 
       <li id="li_C6C2A019FCD945E085E1ABB564C4EDAD"> <code> 10 </code> DPM 트레이트를 식별합니다(오프라인, 인바운드 작업에 의해 온보드). </li> 
       <li id="li_7AFF8A1D0E1140459CC95CF43A97B9B6"> <code> 3 </code> 규칙 기반 트레이트를 식별합니다(DCS를 통해 실시간으로 온보드). </li> 
      </ul> </li> 
     <li id="li_1DDE25334CF9479A8C4738F3CB3C40AA"> <code> traitId </code>:트레이트 ID. </li> 
     <li id="li_DCB89F2A40BB43C98EE3C84B5B3CDD33"> <code> lastRealized </code>:마지막으로 트레이트가 실현된 시간입니다. Unix 타임스탬프 </li> 
    </ul> <p>매크로 뒤에 중괄호로 이 변수를 배치합니다. 예를 들어 이 코드는 "|" 문자로 결과를 구분합니다. <code> &lt;TRAIT_LIST:{trait|&lt;trait.Id&gt;,&lt;trait.lastRealized&gt;};separator="," </code> </p> </td> 
  </tr> 
  <tr> 
