---
description: Marketplace는 데이터 구매자가 연구 및 공개 및 비공개 데이터 피드를 구독하는 곳입니다. 다음 단계에 따라 공개 데이터 피드에 가입합니다.
seo-description: Marketplace는 데이터 구매자가 연구 및 공개 및 비공개 데이터 피드를 구독하는 곳입니다. 다음 단계에 따라 공개 데이터 피드에 가입합니다.
...
데이터 구매자가 [!UICONTROL Marketplace] 리서치를 방문하여 공개 및 비공개 데이터 피드를 구독하는 곳입니다. 다음 단계에 따라 공개 데이터 피드에 가입합니다.
...
>[!TIP]
>
>경우에 따라 데이터 제공업체는 개인 데이터 피드를 할인할 수 있습니다. 구독 요청을 제출할 때 가능한 할인 혜택을 요청할 수 있습니다.
...
또한 [!UICONTROL Audience Marketplace]제공업체는 구매자에게 게시된 요금 [!DNL CPM] 또는 정액 요금 데이터 피드의 가격을 할인해 줄 수 있습니다. 그러나 [!DNL Marketplace] 피드 목록의 구매자는 할인 금액을 볼 수 없습니다. 그러나 개인 데이터 피드에 가입하거나 특정 피드에 대한 추가 정보를 요청할 때 할인을 요청할 수도 있습니다.
...
<table id="table_3C6E58F593BA48EC89ACBD9A26E4E74F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이미 개인 데이터 피드를 구독하고 할인 혜택을 요청하려는 경우: </p> 
    <ol id="ol_A58D419EBB9349E9B1225202535130F6"> 
     <li id="li_D0DDC8AC6E9C4675AA4630D63FE8F071"> <a href="../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#unsubscribe"> 데이터 피드에서 가입</a> 해지. </li> 
     <li id="li_05A5379F2A944FB28AB39C196DDE3A1D">데이터 제공업체에 연락하여 할인된 가격으로 요청하십시오. </li> 
     <li id="li_B1B5AA6F6CC64512A02D5E8861A5F266">공급자가 할인 혜택을 제공하는 경우 다음 달 1<sup>일에</sup> 피드에 다시 가입합니다. </li> 
    </ol> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>새 개인 데이터 피드 구독자</b> </p> </td> 
   <td colname="col2"> <p>구독 신청 시 할인 혜택을 요청하십시오. 개인 <a href="../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#subscript-private-data-feed"> 데이터 피드 가입을 참조하십시오</a>. </p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>잠재적인 가입자</b> </p> </td> 
   <td colname="col2"> <p>잠재적인 구독자는 <a href="../../../features/audience-marketplace/marketplace-private-feeds.md"></a> 개인 데이터 피드에 대한 액세스를 요청하고 판매자 승인을 받았지만 피드에 가입하지 않은 데이터 구매자입니다. 잠재적 가입자로 할인을 요청하려면 </p> 
    <ol id="ol_9CECDA92E7894B20AC8A777D78962188"> 
     <li id="li_618B64160CF24549AFCA73E006DCA35A">Audience <b><span class="uicontrol"> Marketplace &gt; Marketplace로 이동합니다</span></b>. </li> 
     <li id="li_FE52A06B30FC4858B48AF81954365FE9">승인된 피드의 이름을 클릭합니다. </li> 
     <li id="li_763C050AC9464BE380D00F6085B6E540">자세한 <b><span class="uicontrol"> 정보 요청을 클릭합니다</span></b>. 자세한 내용은 판매자에게 문의하십시오. </li> 
    </ol> </td> 
  </tr> 
 </tbody> 
</table>
...
1. 표의 [!UICONTROL Price] 열과 [!UICONTROL Your Price] 열을 [!UICONTROL Plan Details] 보세요. 피드가 할인된 경우:

   * 원래 가격은 빨간색으로 표시되어 있습니다.
   * 열의 요금은 [!UICONTROL Your Price] 열의 수수료보다 [!UICONTROL Price] 낮습니다.

예를 들어 구매자는 해당 [!UICONTROL Segments and Overlap] 플랜에 대해 10% 할인을 받습니다 **[!UICONTROL Software Audience Feed]**.
...
1. 에서 데이터 피드 이름을 [!UICONTROL Marketplace]클릭합니다.
1. 섹션에서 사용할 플랜을 [!UICONTROL Use Case] 찾아 **[!UICONTROL Subscription]** 슬라이더를 다른 위치로 **[!UICONTROL Off]**&#x200B;이동합니다.

## 데이터 피드 비활성화:왜 발생하는지 및 대응 방법 {#data-feed-deactivation-reasons}

에서 [!UICONTROL Audience Marketplace]데이터 공급자는 구독된 데이터 피드에 대한 액세스를 취소할 수 있습니다. 이런 일이 생기면 놀라지 마세요. 우리는 당신을 엄호합니다. 데이터 피드 비활성화와 관련된 프로세스 및 절차는 이 섹션을 검토하십시오.
...
>[!TIP]
>
>데이터 피드가 실수로 비활성화되었다고 생각되면 데이터 공급자에게 직접 문의하십시오. 컨설턴트가 연락처 정보 또는 추가 지원을 도와 드릴 [!DNL Adobe] 수 있습니다.
...
* REST API [또는 벌크](../../../api/rest-api-main/rest-api-main.md) 관리 도구를 사용하여 [벌크](../../../reference/bulk-management-tools/bulk-management-intro.md)제거

* 영향을 받는 세그먼트를 수동으로 검색하고 를 사용하여 비활성화된 트레이트를 제거할 수 [!UICONTROL Segment Builder]있습니다. 세그먼트에서 [트레이트 제거를 참조하십시오](../../../features/segments/segment-builder.md#segment-builder-controls-traits).

>[!NOTE]
>
>활성 알고리즘 모델 또는 대상에서 트레이트를 제거하면 비율 및 타깃팅 정확성에 영향을 줍니다. 취소된 트레이트를 새로운 활성 트레이트로 교체해 보십시오.

[계정에서 해지된 트레이트를 모두 제거한 후 비활성화된 데이터 피드의](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#unsubscribe) 구독을 취소합니다. 임시 비정품 인증인 경우 데이터 공급자가 필요한 변경을 완료하고 피드를 다시 활성화할 수 있습니다. 대부분의 경우와 마찬가지로 파트너(데이터 제공업체 및 [!DNL Adobe])와의 원활한 커뮤니케이션을 통해 이러한 프로세스를 진행할 수 있습니다.
...
1. 계획 정보 단추를 참조하십시오.
   ...
   * 데이터 제공자에게 선택한 데이터 피드에 대해 질문하거나 할인을 요청하려면 을 **[!UICONTROL Request More Details]** 클릭합니다. 이 기능은 의견 및 질문을 데이터 제공자에게 직접 보냅니다.

1. 데이터 피드 보고서 지표를 참조하십시오. 벤 다이어그램(및 관련 지표)은 지난 30일 동안의 트레이트 오버랩 데이터를 보여줍니다. 마켓플레이스 [참조:자세한](marketplace-data-buyers.md#about-marketplace) 내용을 참조하십시오.
   * **[!UICONTROL 30 Day Overlapped Uniques]**:공급자 계정의 사용자와 겹치는 계정의 고유 사용자 수입니다. 고유 사용자에 대한 정의는 Audience Manager의 ID [인덱스의 AAM UUID를 참조하십시오](/help/using/reference/ids-in-aam.md).
   * **[!UICONTROL 30 Day Provider Unique Users]**:공급자 계정에서 들어오는 고유 사용자 수입니다.
   * **[!UICONTROL Your Unique Users]**:계정에서 들어오는 고유 사용자 수입니다.

1. **[!UICONTROL Plan Details]** 표. 이 표에서는 가격 모델을 비롯하여 데이터 피드에 가입할 수 있는 사용 사례를 보여줍니다. 데이터 [피드 사용 사례 이해를 참조하십시오](#use-cases).
...
## 세그먼트 및 중복 플랜을 사용한 비교 {#comparisons}
...
이 사용 사례를 사용하면 [알고리즘 모델링을](../../../features/algorithmic-models/understanding-models.md#understanding-models)통해 트레이트에 대한 공급자 트레이트를 평가할 수 있습니다. 예를 들어, Adobe의 알고리즘 모델링 시스템은 공급자 트레이트와 비교하기 위한 기초로 사용자의 특성 중 하나를 사용합니다. 모델이 실행되면 공급자 트레이트의 대상이 트레이트와 유사한 전환 속성을 공유하는지 여부를 표시할 수 있습니다.
