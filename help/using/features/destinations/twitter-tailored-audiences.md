...
1. Audience Manager 인스턴스에서 첫 [!DNL Twitter Tailored Audiences] 번째 대상을 만들 때는 Adobe 컨설팅 또는 고객 지원 센터에 문의하여 계정에 [!DNL Twitter] ID 동기화 (Data Source ID = 1123) 를 활성화하십시오. Audience Manager와 [!DNL Twitter]사용자 간의 올바른 동기화를 위해 필요합니다.
