...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe <a href="../dil/dil-overview.md"> Launch가 Experience Cloud에서</a> 선호하는 코드 <span class="keyword"> 배포 도구라는 사실을 고려한 DIL 코드</span> 가져오기 및 구현을 <span class="keyword"> 수정했습니다</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_1C70ABC7084E4FA8916E460EDFEE8F85"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/profile-merge-rules/considerations-pmr-device-graph.md"> 장치 그래프와 프로필 병합 규칙에 대한 중요 고려 사항</a> </p> </td> 
   <td colname="col2"> <p>실시간 세그먼트 모집단에서 거의 발생하지 않는 세그먼트에 대해 장치 그래프와 프로필 병합 규칙을 사용하지 마십시오. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../overview/aam-gdpr/aam-gdpr-details.md"> 개인 정보 보호 규정(GDPR)</a> </p> </td> 
