...
먼저 Audience Manager 비디오](https://images-tv.adobe.com/avp/vr/b7f88801-efe0-4786-9d58-554db16b34eb/81b6f004-cec0-452c-9b35-dabdc69ae3b4/9dc8a1d4-350d-46c3-90a6-5197dfb76f40_20180130023449.854x480at800_h264.mp4)에서 세그먼트 만들기 [ 비디오는 세그먼트 만들기 프로세스를 안내합니다. 자세한 내용은 아래 섹션을 참조하십시오.
...
[!UICONTROL Segment Builder] 3개의 개별 섹션으로 구성됩니다. [!UICONTROL Basic Information],  [!UICONTROL Traits]및  [!UICONTROL Destinations Mapping]을 참조하십시오. [!UICONTROL segment]을(를) 만들려면 [!UICONTROL Basic Information] 및 [!UICONTROL Traits] 섹션의 필수 필드를 완료합니다. [!UICONTROL Destinations Mapping] 설정은 선택 사항입니다. 자세한 내용은 아래 지침을 참조하십시오.
...
1. [기본 정보](../../features/segments/segment-builder.md#segment-builder-controls-basics) 섹션에서 다음을 수행합니다.
   ...
   * [!UICONTROL segment] 상태를 설정합니다(활성 상태: 기본값).
   * [!UICONTROL data source]을 선택합니다. 첫 번째 드롭다운 메뉴를 사용하여 Audience Manager [!UICONTROL data sources], Adobe Analytics 보고서 세트 또는 둘 다 필터링합니다. 그런 다음 두 번째 드롭다운 메뉴를 사용하여 [!UICONTROL data source]을 선택합니다. Adobe Analytics 보고서 세트를 사용하지 않는 경우 [!UICONTROL data source] 유형 선택기가 비활성화되어 기본적으로 Audience Manager 데이터 소스로만 설정됩니다.
...
1. *(선택 사항)* 대상 매핑 섹션 [!UICONTROL segment]  [!UICONTROL destination] 에서  [에 ](../../features/segments/segment-builder.md#segment-builder-controls-destinations) a를매핑합니다.
   * [!UICONTROL destination]을 검색하고 **[!UICONTROL Add Destination]**&#x200B;을 클릭합니다. [!UICONTROL segment]에 추가하려면 먼저 [!UICONTROL destination]이(가) 이미 있어야 합니다.
   * 완료되면 **[!UICONTROL Save]**&#x200B;을 클릭합니다.
...
| 필드 | 설명 |
---------|----------
| **[!UICONTROL Name]** | 기능이나 목적을 설명하는 짧고 논리적인 이름을 세그먼트에 지정합니다. 약어와 특수 문자는 사용하지 마십시오. 세그먼트 이름의 최대 길이는 255자입니다. |
| **[!UICONTROL Description]** | 세그먼트에 대한 추가 설명을 위한 필드입니다. |
| **[!UICONTROL Integration Code]** | 사용자 정의 ID 또는 기타 회사 특정 정보에 대한 필드입니다. |
| **[!UICONTROL Data Source]** | 세그먼트를 특정 데이터 공급자에 연결합니다. <br> 첫 번째 드롭다운 메뉴를 사용하여 Audience Manager 데이터 소스, Adobe Analytics 보고서 세트 또는 둘 다 필터링합니다. 그런 다음 두 번째 드롭다운 메뉴를 사용하여 데이터 소스를 선택합니다. <br> Adobe Analytics 보고서 세트를 사용하지 않는 경우 데이터 소스 유형 선택기가 비활성화되어 기본적으로 Audience Manager 데이터 소스로만 표시됩니다. |
| **[!UICONTROL Profile Merge Rule]** | 세그먼트 자격에 사용할 프로필 병합 규칙을 선택합니다. |
| **[!UICONTROL Status]** | 세그먼트를 활성화 또는 비활성화합니다(기본적으로 활성). |
| **폴더 저장소** | 세그먼트가 속한 저장소 폴더를 결정합니다. |

## [!UICONTROL Segment Builder] 컨트롤: [!UICONTROL Traits] 섹션  {#segment-builder-controls-traits}

[!UICONTROL Segment Builder]에서 [!UICONTROL Traits] 섹션에서는 [!UICONTROL segment]의 [!UICONTROL traits]를 관리하고 [!UICONTROL trait] 그룹을 만들고 자격 조건을 설정할 수 있습니다. [!UICONTROL trait]을(를) [!UICONTROL segment]에 추가하려면 검색 필드에 [!UICONTROL trait] 이름을 입력하고 [!UICONTROL Add Trait]을 클릭합니다. [!UICONTROL trait](완료된 경우)을 저장하거나 [!UICONTROL Destinations Mapping](으)로 이동합니다.
...
| 필드 | 설명 |
|--- |--- |
| **[!UICONTROL Basic View]** | 이 섹션에서는 다음과 같은 시각적 컨트롤을 제공합니다. <ul><li>새로 만들고 기존 [!UICONTROL segments]을(를) 관리합니다.</li><li>[!UICONTROL segment]에서 [!UICONTROL traits]을(를) 제거합니다.</li><li>[!UICONTROL segment]에 최대 50(최대) [!UICONTROL traits]을(를) 추가합니다.</li><li>[!UICONTROL traits]을(를) 드래그 앤 드롭하여 새 그룹을 만듭니다.</li><li>[!UICONTROL segment]에서 [!UICONTROL traits] 및 [!UICONTROL trait] 그룹을 봅니다.</li><li>부울 표현식, 비교 연산자 및 최근/빈도 설정으로 자격 조건을 설정합니다.</li></ul> |
| **[!UICONTROL Code View]** | 시각적 인터페이스 대신 코드를 사용하여 [!UICONTROL traits], 그룹 및 자격 요구 사항을 만들고 관리할 수 있는 개발 환경을 엽니다. 코드 보기는 [!UICONTROL segments]: <ul><li>개별 [!UICONTROL segment]에 50개 이상의 [!UICONTROL traits]을(를) 포함합니다. 참고:[!UICONTROL Segments]은(는) 5000 [!UICONTROL traits](최대)로 제한됩니다.</li><li>많은 [!UICONTROL trait] 그룹을 포함합니다.</li><li>복잡한 자격 조건</li></ul> |
...
| **[!UICONTROL Marketplace Recommendations]** | 가입하지 않은 데이터 피드에서 유사한 [!UICONTROL traits]에 대한 실시간 권장 사항을 가져옵니다. [!UICONTROL Audience Marketplace] [트레이트 Recommendations](trait-recommendations.md)에서 자세히 알아보십시오. |
...
[!UICONTROL segments]에서 [!UICONTROL traits]을(를) 관리하는 것은 [!UICONTROL segments] 실행 상태를 유지하는 데 중요한 부분입니다. [!UICONTROL segment]에서 [!UICONTROL traits]을(를) 제거해야 하는 경우 다음 단계를 수행합니다.
...
4. 삭제할 [!UICONTROL trait] 위로 마우스를 가져간 다음 X를 클릭합니다. 이 작업은 [!UICONTROL segment]에서 [!UICONTROL trait]을(를) 즉시 제거합니다.

## [!UICONTROL Segment Builder] 컨트롤: [!UICONTROL Destinations Mappings] 섹션  {#segment-builder-controls-destinations}

[!UICONTROL Segment Builder]에서 선택적 [!UICONTROL Destinations Mapping] 섹션에서 [!UICONTROL segment] 데이터를 타사 [!DNL cookie], [!DNL URL] 또는 [!UICONTROL server-to-server destination]로 보낼 수 있습니다. [!UICONTROL destination]을 추가하려면 [!UICONTROL destination]에 대해 검색(또는 찾아보기)하고 [!UICONTROL destination] 특정 정보를 입력하고 **[!UICONTROL Add Destination]**&#x200B;을 클릭합니다.
...
| 검색 유형 | 설명 |
|---|---|
| **[!UICONTROL Search by Destination Name]** | 이름별로 특정 [!UICONTROL destination]을 검색할 수 있습니다. 검색하려면 입력합니다. 이 필드는 검색어에 따라 자동으로 완성됩니다. 완료되면 **[!UICONTROL Add Destination]**&#x200B;을 클릭합니다. |
| **[!UICONTROL Browse All Destinations]** | 사용할 수 있는 *모든* [!UICONTROL destinations] 목록을 찾아보십시오. 팝업 목록에서 [!UICONTROL destinations]을 선택하고 [!UICONTROL segment]에 추가합니다. |
...
>[!NOTE]
>
>게시 날짜는 선택 사항입니다. 비어 있으면 대상이 활성화되고 만료되지 않습니다.

<!-- r_add_mappings_pop.xml -->

### [!UICONTROL Cookie Destination] 필드

[!UICONTROL Destination Mapping] 필드에서 데이터를 [!UICONTROL destination]에 전송하는 데 사용되는 키-값 쌍을 지정합니다. 첫 번째 필드에 키를 입력하고 두 번째 필드에 값을 입력합니다. [!UICONTROL cookie destination] 팝이 다음과 비슷합니다.
...
[!UICONTROL Destination Value] 필드에서 데이터를 [!UICONTROL destination]에 전송하는 데 사용되는 값(키-값 쌍의 일부)을 지정합니다.
