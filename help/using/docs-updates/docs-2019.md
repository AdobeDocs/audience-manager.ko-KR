...
See the Experience Cloud Release Notes for changes to  and other  solutions. [](https://marketing.adobe.com/resources/help/en_US/whatsnew/)[!DNL Audience Manager][!DNL Experience Cloud] See the Previous Years section for older release notes.[](../docs-updates/docs-2018.md)
...
| 주제 | 설명 |
|--- |----|
| [Destinations Home Page](/help/using/features/destinations/destinations-home.md) | The [Destinations](https://bank.demdex.com/portal/destinations/all) landing page has a new look. 새 레이아웃에 대한 자세한 내용은 이 페이지를 참조하십시오. |
