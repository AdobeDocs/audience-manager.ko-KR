...
<table id="table_366914EEDA294636A580F706AFC57ACC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html?lang=ko" format="https" scope="external"> Audience Manager 쿠키</a> </p> </td> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle"> 실행 가능한 로그 파일</span>이(가) DCM 로그 파일을 <span class="keyword"> Audience Manager</span>(으)로 가져오는 권장되는 방법인 이유를 알아보고 기능을 시작하는 방법에 대해 알아봅니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p><span class="keyword"> Audience Manager</span>에 DCM 데이터 파일 가져오기를 설정한 후 <span class="wintitle"> 실행 가능한 로그 파일</span>을(를) 활성화하기 위해 수행해야 하는 작업에 대한 7단계를 추가했습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><i>이 기능은 더 이상 사용되지 않습니다.</i> <p><span class="keyword"> Experience Cloud 장치 Co-op</span>로 데이터를 보내는 방법을 제어하는 새 구성입니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>데이터 구매자용 <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-data-buyers.md"> Audience Marketplace</a> </p> </td> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="keyword"> Audience Manager</span>에서 모델의 여러 형식 및 원본을 사용할 수 있습니다. <span class="wintitle"> 대상 랩</span>은(는) 활성 모델에서 고객의 전환율을 쉽게 비교할 수 있는 방법을 제공합니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>DCS API 호출에 지원되는 특성 <a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md">개</a> </p> </td> 
   <td colname="col2"> <p>Audience Manager에서 개인 매개 변수를 식별하면서 <code> _p</code>(으)로 주요 변수 접두사를 업데이트했습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이 섹션에는 <span class="wintitle"> 프로필 링크</span> 및 타사 장치 그래프 옵션을 지원하도록 새 콘텐츠 및 수정된 콘텐츠가 포함되어 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/more-resources/dns-prefetch.html?lang=ko" format="https" scope="external"> 다른 Experience Cloud 솔루션에서 DNS 프리페치를 사용</a> </p> </td> 
...
[!DNL Audience Manager] 릴리스 정보 및 설명서 변경 내용에 대한 링크입니다. [!DNL Experience Cloud] 수준의 이전 변경 내용을 보관하려면 [이전 릴리스 정보](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html?lang=ko) 섹션을 참조하십시오.
